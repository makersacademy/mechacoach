...
describe ParseGithub do
  describe '.with' do
    ...
    it 'raises an error if the issue action is not "opened"' do
      expect { described_class.with(bad_issue_opening_payload) }.to raise_error 'I can only deal with brand new issues.'
    end
